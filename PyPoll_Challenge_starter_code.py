...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        county_vote_percentage = (votes_count / total_votes) * 100

        # 6d: Print the county results to the terminal.
        print(f"{county_name}, {county_vote_percentage:.1f}% ({county_votes[county_name]:,})")
        ...
        if (votes_count > winning_county_count) and (county_vote_percentage > winning_county_percentage):
